...
%---------------------------------------------------------------------------%
\documentclass[singlesided,cuzhdr]{styles/cuzreview}%
...
\begin{document}
%-> Initialization
\input{src/thesis/frontmatter/initialization}
%-
...
\begin{tcolorbox}[
	...
	$\!$ % BUG: there should be some text above the first section title within a
	% tcolorbox; otherwise the spacing above each section title will be missing.
	\input{src/review/reviewbody.tex}
	\nomatter
	%-> The references
