...
% - texcomments=true：允许在代码注释中使用 LaTeX 命令
% - breaklines=true：自动换行
% - fontsize=\small：设置代码字体大小
...
% 全局设置代码高亮样式（可选）
% \setminted{
%   style=tango,          % 代码高亮主题：tango, autumn, perldoc, borland, colorful
%   fontsize=\small,      % 代码字体大小
%   linenos=true,         % 显示行号
%   breaklines=true,      % 自动换行
%   tabsize=4,            % Tab 宽度为 4 个空格
%   frame=lines,          % 添加上下边框
%   framesep=2mm,         % 边框与代码的间距
%   autogobble=true,      % 自动删除每行开头的空白
%   baselinestretch=1.2,  % 行间距
%   bgcolor=gray!10       % 背景色（浅灰色）
% }
...
%    \end{listing}
%
% 常用语言：c, cpp, java, python, html, xml, latex, bash, sql, javascript
% 常用选项：
%   - linenos：显示行号
%   - breaklines：自动换行
%   - fontsize=\footnotesize：设置字体大小
%   - frame=lines：添加上下边框
%   - style=tango：设置高亮主题
%   - texcomments：允许在注释中使用 LaTeX 命令
%---------------------------------------------------------------------------%
%->> 文档内容
%---------------------------------------------------------------------------%
\begin{document}
